            ...
            >
              <div className="w-full overflow-hidden">
                <img
                  ...
                  alt={movie.title}
                  className="w-full h-[332px] object-cover aspect-[3/4] bg-[#1111] rounded overflow-hidden flex items-center justify-center transition-transform duration-300 hover:scale-105 cursor-pointer"
                />
              </div>
              <div className="p-4 space-y-2">
                ...
                <p className="absolute top-8 px-2 py-1 rounded-[6px] bg-yellow-500 flex gap-1 items-center justify-between text-[12px] text-white font-medium max-[600px]:text-[10px] max-[600px]:left-1">
